...
async fn test_ltrim() {
    ...
    match res {
        Resp::Array(Some(items)) => {
            ...
            match &items[2] {
                Resp::BulkString(Some(b)) => assert_eq!(b, &Bytes::from("d")),
                _ => panic!(),
            }
        }
